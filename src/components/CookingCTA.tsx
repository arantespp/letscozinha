...
export async function CookingCTA() {
  ...
  return (
    <section className="container my-xl overflow-hidden">
      <div className="bg-gradient-to-r from-primary/20 to-accent/20 rounded-xl p-lg md:p-xl relative">
        ...
        <div className="grid md:grid-cols-2 gap-xl items-center">
          ...
          <div className="relative mx-auto">
            <div className="relative aspect-square w-64 md:w-80 overflow-hidden rounded-full">
              <div className="absolute inset-0 border-8 border-neutral rounded-full z-10" />
              <Image
